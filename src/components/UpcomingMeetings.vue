<template>
    <section class="w-[100vw] m-10 relative">
            ...
            <div class="flex justify-center items-center  xl:w-[30%]">
                <div class="max-w-[720px]">
                    <div
                        ...
                        <div class="p-6 border-t-4 border-primary-blue">
                            <h4
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1280 320" class="xl:block hidden absolute w-full -bottom-10 -z-10">
            <path fill="#01284F"
                d="M0,128L80,160C160,192,320,256,480,240C640,224,800,128,960,96C1120,64,1280,96,1360,112L1440,128L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z" />
        </svg>
    </section>
</template>
